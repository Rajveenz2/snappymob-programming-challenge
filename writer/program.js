...
var genMainFile = function (
  ...
  while (finalOutput.join(",").length < OUTPUT_SIZE) {
    var limit = Random.integer(1, 100); // limit of each items (can be set to remaining filesize)
  ...
  fs.writeFile(
    ...
    function (err, content) {
      ...
      // Log the content that is being saved
